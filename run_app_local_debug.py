...
DESKTOP_LAUNCHER = PROJECT_ROOT / "main_ui_node_desktop_local_debug.js"
...
def main() -> int:
    if not DESKTOP_LAUNCHER.exists():
        sys.stderr.write(
            "未找到本地调试启动脚本 main_ui_node_desktop_local_debug.js。\n",
        )
        return 1
    ...
    if not node_executable:
        sys.stderr.write(
            "未找到 Node.js，请先安装 Node.js 或直接使用 node main_ui_node_desktop_local_debug.js。\n",
        )
        return 1
