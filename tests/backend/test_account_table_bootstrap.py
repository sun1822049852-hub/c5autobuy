...
def test_create_schema_normalizes_legacy_http_c5_product_urls(tmp_path):
    db_path = tmp_path / "app.db"
    connection = sqlite3.connect(db_path)
    connection.execute(
        """
    ...
    connection.execute(
        ...
        (
            "1380979899390267001",
            "http://www.c5game.com/csgo/730/asset/1380979899390267001",
            "AK-47 | Redline",
            "AK-47 | Redline (Field-Tested)",
            0.12,
            0.8,
    ...
    assert product_row == ("https://www.c5game.com/csgo/730/asset/1380979899390267001",)
    assert item_row == ("https://www.c5game.com/csgo/730/asset/1380979899390267001",)
